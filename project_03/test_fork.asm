...
_test_fork:     file format elf32-i386
...
int main(int argc, char** argv) {
  ...
  28:	75 5d                	jne    87 <main+0x87>
			printf(1, "Child\n");
  2a:	83 ec 08             	sub    $0x8,%esp
  2d:	68 00 08 00 00       	push   $0x800
  32:	6a 01                	push   $0x1
  34:	e8 67 04 00 00       	call   4a0 <printf>
			yield();
  39:	e8 64 03 00 00       	call   3a2 <yield>
  3e:	83 c4 10             	add    $0x10,%esp
	while (cnt) {
  41:	83 eb 01             	sub    $0x1,%ebx
  44:	74 21                	je     67 <main+0x67>
		if (pid > 0) {
  46:	83 fe 00             	cmp    $0x0,%esi
  49:	7e dd                	jle    28 <main+0x28>
			printf(1, "Parent\n");
  4b:	83 ec 08             	sub    $0x8,%esp
  4e:	68 f8 07 00 00       	push   $0x7f8
  53:	6a 01                	push   $0x1
  55:	e8 46 04 00 00       	call   4a0 <printf>
			yield();
  5a:	e8 43 03 00 00       	call   3a2 <yield>
  5f:	83 c4 10             	add    $0x10,%esp
	while (cnt) {
  62:	83 eb 01             	sub    $0x1,%ebx
  65:	75 df                	jne    46 <main+0x46>
			break;
		}
		cnt--;
	}
	...
	if(pid == 0){
  67:	83 fe 00             	cmp    $0x0,%esi
  6a:	74 0c                	je     78 <main+0x78>
		sleep(2);
	}
	else if (pid > 0) {
  6c:	7e 05                	jle    73 <main+0x73>
		wait();
  6e:	e8 87 02 00 00       	call   2fa <wait>
	}
	exit();
  73:	e8 7a 02 00 00       	call   2f2 <exit>
		sleep(2);
  78:	83 ec 0c             	sub    $0xc,%esp
  7b:	6a 02                	push   $0x2
  7d:	e8 00 03 00 00       	call   382 <sleep>
  82:	83 c4 10             	add    $0x10,%esp
  85:	eb ec                	jmp    73 <main+0x73>
			printf(1, "fork fail\n");
  87:	50                   	push   %eax
  88:	50                   	push   %eax
  89:	68 07 08 00 00       	push   $0x807
  8e:	6a 01                	push   $0x1
  90:	e8 0b 04 00 00       	call   4a0 <printf>
  95:	83 c4 10             	add    $0x10,%esp
  98:	eb d9                	jmp    73 <main+0x73>
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 12 08 00 00       	mov    $0x812,%ebx
        while(*s != 0){
