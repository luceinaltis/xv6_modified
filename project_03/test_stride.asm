  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  22:	e8 69 02 00 00       	call   290 <atoi>
  ...
  if (set_cpu_share(cpu_share) < 0) {
  2c:	e8 91 03 00 00       	call   3c2 <set_cpu_share>
  31:	83 c4 10             	add    $0x10,%esp
  34:	85 c0                	test   %eax,%eax
  36:	78 46                	js     7e <main+0x7e>
  ...
  int cnt = 0;
  41:	b8 40 42 0f 00       	mov    $0xf4240,%eax
  ...
  while (1) {
    ...
    __sync_synchronize();
  50:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  ...
  58:	75 f6                	jne    50 <main+0x50>
      ...
      // Get current time
      curr_tick = uptime();
  5a:	e8 3b 03 00 00       	call   39a <uptime>

      if (curr_tick - start_tick > LIFETIME) {
  5f:	29 f0                	sub    %esi,%eax
      cnt++;
  61:	83 c3 01             	add    $0x1,%ebx
      if (curr_tick - start_tick > LIFETIME) {
  64:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  69:	76 d6                	jbe    41 <main+0x41>
        // Terminate process
        printf(1, "STRIDE(%d%%), cnt: %d\n", cpu_share, cnt);
  6b:	53                   	push   %ebx
  6c:	57                   	push   %edi
  6d:	68 46 08 00 00       	push   $0x846
  72:	6a 01                	push   $0x1
  ...
  exit();
  79:	e8 84 02 00 00       	call   302 <exit>
    printf(1, "cannot set cpu share\n");
  7e:	50                   	push   %eax
  7f:	50                   	push   %eax
  80:	68 30 08 00 00       	push   $0x830
  85:	6a 01                	push   $0x1
  87:	e8 24 04 00 00       	call   4b0 <printf>
    exit();
  8c:	e8 71 02 00 00       	call   302 <exit>
    printf(1, "usage: sched_test_stride cpu_share(%)\n");
  91:	52                   	push   %edx
  92:	52                   	push   %edx
  ...
  9a:	e8 11 04 00 00       	call   4b0 <printf>
    exit();
  9f:	e8 5e 02 00 00       	call   302 <exit>
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
...
000003c2 <set_cpu_share>:
SYSCALL(set_cpu_share)
 3c2:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3c7:	cd 40                	int    $0x40
 3c9:	c3                   	ret    

000003ca <thread_exit>:
SYSCALL(thread_exit)
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 5d 08 00 00       	mov    $0x85d,%ebx
        while(*s != 0){
