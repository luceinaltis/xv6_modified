  ...
  14:	31 f6                	xor    %esi,%esi
{
  ...
  2b:	68 ab 86 01 00       	push   $0x186ab
  30:	68 b0 00 00 00       	push   $0xb0
  35:	57                   	push   %edi
  36:	83 c7 04             	add    $0x4,%edi
  39:	e8 b4 03 00 00       	call   3f2 <thread_create>
		for(i = 0; i < THREAD_NUMBER; ++i)
  ...
  50:	8d 04 3b             	lea    (%ebx,%edi,1),%eax
  53:	83 ec 08             	sub    $0x8,%esp
  56:	83 c7 04             	add    $0x4,%edi
  59:	50                   	push   %eax
  5a:	ff 74 2f 94          	pushl  -0x6c(%edi,%ebp,1)
  5e:	e8 97 03 00 00       	call   3fa <thread_join>
		for(i = 0; i < THREAD_NUMBER; ++i)
  63:	83 c4 10             	add    $0x10,%esp
  66:	83 ff 28             	cmp    $0x28,%edi
  69:	75 e5                	jne    50 <main+0x50>
		}	

		if(j %1000 == 0)
  6b:	b8 d3 4d 62 10       	mov    $0x10624dd3,%eax
  70:	f7 e6                	mul    %esi
  72:	c1 ea 06             	shr    $0x6,%edx
  75:	69 d2 e8 03 00 00    	imul   $0x3e8,%edx,%edx
  7b:	39 d6                	cmp    %edx,%esi
  7d:	74 11                	je     90 <main+0x90>
	for(int j = 0; j < 10000; j++)
  7f:	83 c6 01             	add    $0x1,%esi
  82:	81 fe 10 27 00 00    	cmp    $0x2710,%esi
  88:	75 96                	jne    20 <main+0x20>
	...
	exit();
  8a:	e8 93 02 00 00       	call   322 <exit>
  8f:	90                   	nop
			printf(1, "j : %d\n", j);
  90:	83 ec 04             	sub    $0x4,%esp
  93:	56                   	push   %esi
  94:	68 28 08 00 00       	push   $0x828
  99:	6a 01                	push   $0x1
  9b:	e8 30 04 00 00       	call   4d0 <printf>
  a0:	83 c4 10             	add    $0x10,%esp
  a3:	eb da                	jmp    7f <main+0x7f>
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
  ab:	66 90                	xchg   %ax,%ax
...
000000b0 <start_routine>:
{
  ...
  bb:	7e 0f                	jle    cc <start_routine+0x1c>
  bd:	01 05 04 0b 00 00    	add    %eax,0xb04
	thread_exit((void*)local_counter);
  c3:	83 ec 0c             	sub    $0xc,%esp
  c6:	50                   	push   %eax
  c7:	e8 1e 03 00 00       	call   3ea <thread_exit>
	int local_counter = 0;
  cc:	31 c0                	xor    %eax,%eax
  ce:	eb f3                	jmp    c3 <start_routine+0x13>
...
0000041a <get_log_num>:
SYSCALL(get_log_num)
 41a:	b8 21 00 00 00       	mov    $0x21,%eax
 41f:	cd 40                	int    $0x40
 421:	c3                   	ret    
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 38 08 00 00 	movzbl 0x838(%edx),%edx
  }while((x /= base) != 0);
 ...
 4a0:	e8 9d fe ff ff       	call   342 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 510:	e8 2d fe ff ff       	call   342 <write>
 ...
 571:	e8 cc fd ff ff       	call   342 <write>
 ...
 588:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 58a:	e8 b3 fd ff ff       	call   342 <write>
  for(i = 0; fmt[i]; i++){
 ...
 623:	57                   	push   %edi
 624:	53                   	push   %ebx
 625:	e8 18 fd ff ff       	call   342 <write>
        while(*s != 0){
 ...
 677:	e8 c6 fc ff ff       	call   342 <write>
        ap++;
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 30 08 00 00       	mov    $0x830,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 08 0b 00 00       	mov    %eax,0xb08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 08 0b 00 00    	mov    0xb08,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 08 0b 00 00    	cmp    %eax,0xb08
 787:	89 c2                	mov    %eax,%edx
 789:	75 ed                	jne    778 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 78b:	83 ec 0c             	sub    $0xc,%esp
 78e:	56                   	push   %esi
 78f:	e8 16 fc ff ff       	call   3aa <sbrk>
  if(p == (char*)-1)
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 08 0b 00 00    	mov    0xb08,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 08 0b 00 00    	mov    %edx,0xb08
}
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 0c 0b 00 00       	mov    $0xb0c,%eax
 809:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 810:	00 00 00 
