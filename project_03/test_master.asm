...
main(int argc, char *argv[])
{
  ...
  for (i = 0; i < CNT_CHILD; i++) {
   f:	31 db                	xor    %ebx,%ebx
    pid = fork();
  11:	e8 b4 02 00 00       	call   2ca <fork>
    if (pid > 0) {
  16:	83 f8 00             	cmp    $0x0,%eax
  19:	7f 2c                	jg     47 <main+0x47>
      // parent
      continue;
    } else if (pid == 0) {
  1b:	75 4b                	jne    68 <main+0x68>
      // child
      exec(child_argv[i][0], child_argv[i]);
  1d:	6b db 0c             	imul   $0xc,%ebx,%ebx
  20:	52                   	push   %edx
  21:	52                   	push   %edx
  22:	8d 83 e0 0a 00 00    	lea    0xae0(%ebx),%eax
  28:	50                   	push   %eax
  29:	ff b3 e0 0a 00 00    	pushl  0xae0(%ebx)
  2f:	e8 d6 02 00 00       	call   30a <exec>
      printf(1, "exec failed!!\n");
  34:	59                   	pop    %ecx
  35:	5b                   	pop    %ebx
  36:	68 d8 07 00 00       	push   $0x7d8
  3b:	6a 01                	push   $0x1
  3d:	e8 3e 04 00 00       	call   480 <printf>
      exit();
  42:	e8 8b 02 00 00       	call   2d2 <exit>
  for (i = 0; i < CNT_CHILD; i++) {
  47:	83 c3 01             	add    $0x1,%ebx
  4a:	83 fb 04             	cmp    $0x4,%ebx
  4d:	75 c2                	jne    11 <main+0x11>
      exit();
    }
  }
  ...
  for (i = 0; i < CNT_CHILD; i++) {
    wait();
  4f:	e8 86 02 00 00       	call   2da <wait>
  54:	e8 81 02 00 00       	call   2da <wait>
  59:	e8 7c 02 00 00       	call   2da <wait>
  5e:	e8 77 02 00 00       	call   2da <wait>
  }
 ...
 3e9:	85 d2                	test   %edx,%edx
{
 ...
 417:	f7 f1                	div    %ecx
 419:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb 14 08 00 00       	mov    $0x814,%ebx
        while(*s != 0){
 ...
 651:	a1 10 0b 00 00       	mov    0xb10,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 10 0b 00 00       	mov    %eax,0xb10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 10 0b 00 00    	mov    0xb10,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 10 0b 00 00    	cmp    %eax,0xb10
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 10 0b 00 00    	mov    0xb10,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 10 0b 00 00    	mov    %edx,0xb10
}
 ...
 7a7:	0b 00 00 
 7aa:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 7b1:	0b 00 00 
    base.s.size = 0;
 7b4:	b8 14 0b 00 00       	mov    $0xb14,%eax
 7b9:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 7c0:	00 00 00 
