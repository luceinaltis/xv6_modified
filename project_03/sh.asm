     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 cc 18 00 00       	push   $0x18cc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 cc 18 00 00       	push   $0x18cc
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 c4 18 00 00       	push   $0x18c4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 cc 18 00 00       	push   $0x18cc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 cc 18 00 00       	push   $0x18cc
...
00000dd2 <set_cpu_share>:
SYSCALL(set_cpu_share)
     dd2:	b8 1a 00 00 00       	mov    $0x1a,%eax
     dd7:	cd 40                	int    $0x40
     dd9:	c3                   	ret    

00000dda <thread_exit>:
SYSCALL(thread_exit)
     dda:	b8 1d 00 00 00       	mov    $0x1d,%eax
     ddf:	cd 40                	int    $0x40
     de1:	c3                   	ret    
     ...
     e29:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
     ...
     e90:	e8 9d fe ff ff       	call   d32 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     f00:	e8 2d fe ff ff       	call   d32 <write>
  ...
  write(fd, &c, 1);
     ...
     f61:	e8 cc fd ff ff       	call   d32 <write>
  ...
  write(fd, &c, 1);
     f7a:	e8 b3 fd ff ff       	call   d32 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    1013:	57                   	push   %edi
    1014:	53                   	push   %ebx
    1015:	e8 18 fd ff ff       	call   d32 <write>
        while(*s != 0){
    ...
    1091:	a1 44 19 00 00       	mov    0x1944,%eax
{
  ...
  freep = p;
    10cf:	a3 44 19 00 00       	mov    %eax,0x1944
}
    10d4:	5b                   	pop    %ebx
    10d5:	5e                   	pop    %esi
    10d6:	5f                   	pop    %edi
    ...
    10e6:	72 ce                	jb     10b6 <free+0x26>
{
  ...
  freep = p;
    110a:	a3 44 19 00 00       	mov    %eax,0x1944
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  return freep;
    119b:	8b 15 44 19 00 00    	mov    0x1944,%edx
    ...
    11e7:	19 00 00 
    11ea:	c7 05 48 19 00 00 48 	movl   $0x1948,0x1948
    11f1:	19 00 00 
    base.s.size = 0;
    11f4:	b8 48 19 00 00       	mov    $0x1948,%eax
    11f9:	c7 05 4c 19 00 00 00 	movl   $0x0,0x194c
    1200:	00 00 00 
